...
public static class EditorAutomaticAddressables {
    ...
    private static Dictionary<Flavour.Setting_EAddressablesVariant, string> s_flavourAddressablesVariantToAssetFolder;

    private static void Flavour_Init()
    {
        if (s_flavourAddressablesVariantToAssetFolder == null)
        {
            s_flavourAddressablesVariantToAssetFolder = new Dictionary<Flavour.Setting_EAddressablesVariant, string>();
            s_flavourAddressablesVariantToAssetFolder.Add(Flavour.Setting_EAddressablesVariant.WW, "");

            // flavourAddressablesVariant, folder name where the assets for flavourSku are stored in
            s_flavourAddressablesVariantToAssetFolder.Add(Flavour.Setting_EAddressablesVariant.CN, "flavour_china");
        }
    }

    public static string FlavourAddressablesVariantToAssetFolder(Flavour.Setting_EAddressablesVariant flavourAddressablesVariant)
    {
        string returnValue = "";
        ...
        else
        {
            ...
            returnValue = Flavour.Setting_EAddressablesVariantToString(flavourAddressablesVariant);                
        }
    ...
    private static void GetEntriesPrefab(out List<AddressablesCatalogEntry> entryList, out List<string> bundleList) {
        ...
        foreach (KeyValuePair<Flavour.Setting_EAddressablesVariant, string> pair in s_flavourAddressablesVariantToAssetFolder)
        {
            GetFlavourEntriesPrefab(pair.Key, ref entryList, ref bundleList);
        }        
    }    

    private static void GetFlavourEntriesPrefab(Flavour.Setting_EAddressablesVariant flavourSku, ref List<AddressablesCatalogEntry> _entries, ref List<string> _bundles) {
    ...
    private static void GetEntriesFromDirectory(Flavour.Setting_EAddressablesVariant flavourAddressablesVariant, string _directoryPath, bool _addLastFolder, List<AddressablesCatalogEntry> _entries, HashSet<string> _bundles, System.Type[] _allowedTypes = null, BuildTarget platform = BuildTarget.NoTarget,
    ...
    private static void GetEntriesFromDirectory(Flavour.Setting_EAddressablesVariant flavourAddressablesVariant, DirectoryInfo _directory, bool _addLastFolder,  List<AddressablesCatalogEntry> _entries, HashSet<string> _bundles, System.Type[] _allowedTypes = null, BuildTarget platform = BuildTarget.NoTarget,
                                                AddressablesTypes.ELocationType locationType = AddressablesTypes.ELocationType.AssetBundles, string defineSymbol = null, bool addToCatalogPlayer = true) {       
            ...
            if (ai != null) {
                ...
                if (locationType == AddressablesTypes.ELocationType.Resources || locationType == AddressablesTypes.ELocationType.AssetBundles && !string.IsNullOrEmpty(assetBundle)) {                 
                    ...
                    if (createEntry) {
                        ...
                        if (variant == null)
                        {
                            variant = Flavour.Setting_EAddressablesVariantToString(flavourAddressablesVariant);
                        }
                        else
                        {
                            variant = Flavour.Setting_EAddressablesVariantToString(flavourAddressablesVariant) + HDAddressablesManager.FLAVOUR_VARIANT_SEPARATOR + variant;
                        }
