...
public class RangeIntEditor : PropertyDrawer {
	//------------------------------------------------------------------//
	// CONSTANTS														//
	//------------------------------------------------------------------//
	...
	public override void OnGUI(Rect _position, SerializedProperty _property, GUIContent _label) {
		...
		if(limits == null) {
			...
			RangeInt tempRange = new RangeInt(minValue, maxValue);
	...
	private void UpdateLimits(int _minValue, int _maxValue) {
		limits.min = (int)MathUtils.PreviousMultiple(_minValue, ZOOM_LEVELS[(int)zoom]);
		limits.max = (int)MathUtils.NextMultiple(_maxValue, ZOOM_LEVELS[(int)zoom]);
	}
}