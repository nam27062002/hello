...
public class CustomParticleControl : MonoBehaviour {

//	private ParticleScaler m_scaler;
	private List<CustomParticleSystem> m_subsystems = null;
...
//		m_scaler = GetComponent<ParticleScaler>();
		m_subsystems = transform.FindComponentsRecursive<CustomParticleSystem>();
	}
