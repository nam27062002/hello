...
public class WorldSpacePositioner : MonoBehaviour {
	...
	void LateUpdate() {
		...
		Vector2 offset = ScreenUtils_OLD.WorldToCanvas(targetWorldPosition);	// The 2D offset to be applied to the object to position it at the 2D projection in the canvas of the target world position
