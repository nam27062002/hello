...
{
	public class SliderNoCallbackEditor : MonoBehaviour {
		...
		public static GameObject CreateSlider(Resources resources)
        {
            ...
            GameObject root = CreateUIElementRoot("SliderNoCallback", s_ThinElementSize);
			...
			SliderNoCallback slider = root.AddComponent<SliderNoCallback>();
		...
		[MenuItem("GameObject/UI/Slider No Callback", false, 2033)]
	    static public void AddSlider(MenuCommand menuCommand)
	    {
			GameObject go = SliderNoCallbackEditor.CreateSlider(GetStandardResources());
