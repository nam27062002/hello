...
public class SceneParticlePooling : MonoBehaviour
{
    #region manager
	...
	private static List<SceneParticlePooling> Manager_Items { get; set; }
	...
	private static void Manager_AddItem(SceneParticlePooling item)
    {
        if (Manager_IsEnabled)
        {
            if (Manager_Items == null)
            {
				Manager_Items = new List<SceneParticlePooling>();
            }
	...
	private static void Manager_RemoveItem(SceneParticlePooling item)
    {
	...
	private static void Manager_UpdateItem(SceneParticlePooling item, bool isVisible)
    {
        if (item != null)
        {
    ...
    public ParticleData m_particle;
   	public GameObject m_particleInstance = null;
