...
/// </summary>
public class ARCoreTrackedPlaneVisualizer : MonoBehaviour
{
	...
	#if (UNITY_ANDROID && ARCORE_SDK_ENABLED)
	...
	public void Update()
	{
		...
		if (m_MeshRenderer != null)
		{
			m_MeshRenderer.enabled = m_bCanRender;
