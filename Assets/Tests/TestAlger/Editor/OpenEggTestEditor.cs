...
//----------------------------------------------------------------------------//
/// <summary>
/// Custom editor for the OpenEggTest class.
/// </summary>
[CustomEditor(typeof(OpenEggTest), true)]	// True to be used by heir classes as well
[CanEditMultipleObjects]
public class OpenEggTestEditor : Editor {
	//------------------------------------------------------------------------//
	// CONSTANTS															  //
	//------------------------------------------------------------------------//
	...
	OpenEggTest m_targetOpenEggTest = null;
	...
	private void OnEnable() {
		// Get target object
		m_targetOpenEggTest = target as OpenEggTest;
	}
