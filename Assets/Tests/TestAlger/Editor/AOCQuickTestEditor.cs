...
/// </summary>
[CustomPropertyDrawer(typeof(AOCQuickTest.EaseCurve))]
public class AOCQuickTestEaseCurveEditor : ExtendedPropertyDrawer {
	/// <summary>
	...
	protected override void OnGUIImpl(SerializedProperty _property, GUIContent _label) {
		...
		m_pos.height = AOCQuickTestEditor.m_curvePreviewSize;
