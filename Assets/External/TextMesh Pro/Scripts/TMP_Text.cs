...
namespace TMPro
{
    ...
    public class TMP_Text : MaskableGraphic
    {
        ...
        {
            get { return m_text; }
            set { if (m_text == value) return; m_text = value; m_inputSource = TextInputSources.String; m_havePropertiesChanged = true; m_isCalculateSizeRequired = true; m_isInputParsingRequired = true; SetVerticesDirty(); SetLayoutDirty(); }
        }
        [SerializeField]
            ...
            else
            {
                ...
                switch (m_xmlAttribute[0].nameHashCode)
                {
                    ...
                    case 1619421: // <SPRITE>
                        ...
                        else if (m_xmlAttribute[1].nameHashCode == 43347 || m_xmlAttribute[1].nameHashCode == 30547) // <sprite name=""> or <SPRITE NAME="">
                        {
                        ...
                        else if (m_xmlAttribute[1].nameHashCode == 295562 || m_xmlAttribute[1].nameHashCode == 205930) // <sprite index=xx> or <SPRITE INDEX=>
                        {
