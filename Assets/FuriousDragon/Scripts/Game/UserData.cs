...
public class UserData : MonoBehaviour {
	...
	public void AddCoins(long _iAmount) {
		...
		mCoins += _iAmount;
		Messenger.Broadcast<long, long>(GameEvents.PROFILE_COINS_CHANGED, mCoins - _iAmount, mCoins);
	}
	...
	public void AddPC(long _iAmount) {
		...
		// Compute new value and dispatch event
		mPC += _iAmount;
		Messenger.Broadcast<long, long>(GameEvents.PROFILE_PC_CHANGED, mPC - _iAmount, mPC);
	}
	#endregion
}
#endregion