...
public class CoinsSpawner : MonoBehaviour {
	...
	void Start() {
		...
		Messenger.AddListener<long, GameEntity>(GameEvents.REWARD_COINS, OnCoinsReward);
	}
	...
	void OnDestroy() {
		...
		Messenger.RemoveListener<long, GameEntity>(GameEvents.REWARD_COINS, OnCoinsReward);
	}
	#endregion
