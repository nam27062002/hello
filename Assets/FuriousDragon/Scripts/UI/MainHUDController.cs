...
public class MainHUDController : MonoBehaviour {
	...
	void Awake() {
		...
		Messenger.AddListener<long, long>(GameEvents.SCORE_CHANGED, OnScoreChanged);
		Messenger.AddListener<long, long>(GameEvents.PROFILE_COINS_CHANGED, OnCoinsChanged);
		...
		Messenger.AddListener<Collectible>(GameEvents.COLLECTIBLE_COLLECTED, OnCollectibleCollected);
	}
	...
	void OnDestroy() {
		...
		Messenger.RemoveListener<long, long>(GameEvents.SCORE_CHANGED, OnScoreChanged);
		Messenger.RemoveListener<long, long>(GameEvents.PROFILE_COINS_CHANGED, OnCoinsChanged);
		...
		Messenger.RemoveListener<Collectible>(GameEvents.COLLECTIBLE_COLLECTED, OnCollectibleCollected);
	}
	#endregion
