 Shader "Custom/TransparentRimLight" 
 {
	Properties 
	{
		...
		_RimIntensity ("Rim Intensity", Range (0,2.0)) = 1.0
		...
		_Alpha ("Alpha Strength", Range (0,1.0)) = 0.8
...
#pragma exclude_renderers xbox360
			...
			v2f vert (appdata v)
			{
                ...
                o.rimcol = o.color * _RimIntensity;
