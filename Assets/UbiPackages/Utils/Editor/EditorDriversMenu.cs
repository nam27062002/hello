...
#region country
    ...
    {
        Platform_SetDevicePlatformString(Flavour.SETTING_EDEVICEPLATFORM_IOS);
    }

    [MenuItem(DRIVERS_PLATFORM_IOS, true)]
    public static bool Platform_SetIOSValidate()
    {
        Menu.SetChecked(DRIVERS_PLATFORM_IOS, Platform_GetDevicePlatformAsString() == Flavour.SETTING_EDEVICEPLATFORM_IOS);
        return true;
    }
    ...
    {
        Platform_SetDevicePlatformString(Flavour.SETTING_EDEVICEPLATFORM_ANDROID);
    }

    [MenuItem(DRIVERS_PLATFORM_ANDROID, true)]
    public static bool Platform_SetAndroidValidate()
    {
        Menu.SetChecked(DRIVERS_COUNTRY_ON_INSTALL_CHINA, Platform_GetDevicePlatformAsString() == Flavour.SETTING_EDEVICEPLATFORM_ANDROID);
        return true;
    }
#endregion
}