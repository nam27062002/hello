...
public class SaveFacade : AutoGeneratedSingleton<SaveFacade>
{
    ...
    private TrackingSaveSystem m_trackingSaveSystem = null;
    ...
    public void Reset()
    {
        ...
        if (m_trackingSaveSystem != null)
        {
            m_trackingSaveSystem.Reset();
            UnregisterSaveSystem(m_trackingSaveSystem);
            m_trackingSaveSystem = null;
        }
    }
    ...
    private TrackingSaveSystem trackingSaveSystem { get { return m_trackingSaveSystem; } }
    #endregion
    ...
    public void Init()
    {
        ...
        m_trackingSaveSystem = HDTrackingManager.Instance.TrackingSaveSystem;
        if (m_trackingSaveSystem != null)
        {
            RegisterSaveSystem(m_trackingSaveSystem);
        }
    }
