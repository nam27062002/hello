...
namespace UnityEngine.GIF
{
    public class GifDecoder
    {
        ...
        public static class ColorUtil
        {
            ...
            {
                byte[] pixels = { (byte)color.a, (byte)color.r, (byte)color.g, (byte)color.b };
                return BitConverter.ToInt32(pixels, 0);
            }
        }
        ...
        public class Image
        {
            ...
            public Color[] Pixels { get { return m_pixels; } }

            protected Color[] m_pixels = null;
            ...
            private int PixelPosFlipY(int x, int y)
            {
                return PixelPos(x, (Height - 1) - y);
            }

            public Color GetPixel(int x, int y)
            {
                return m_pixels[PixelPos(x, y)];
            }

            public void SetPixel(int x, int y, Color color)
            {
                //  Flip Y
                m_pixels[PixelPosFlipY(x, y)] = color;
            }
        }
        ...
        int[] GetPixels(Image bitmap)
        {
            ...
            for (int th = 0; th < image.Height; th++)
            {
                for (int tw = 0; tw < image.Width; tw++)
                {
                    ...
                    pixels[count] = (int)color.r;
                    count++;
                    pixels[count] = (int)color.g;
                    count++;
                    pixels[count] = (int)color.b;
                    count++;
                }
            }
            return pixels;
        ...
        void SetPixels(int[] pixels)
        {
            ...
            for (int th = 0; th < image.Height; th++)
            {
                for (int tw = 0; tw < image.Width; tw++)
                {
                    ...
                    Color color = ColorUtil.FromInt(pixel);
        ...
        protected void SetPixels()
        {
            ...
            if (lastDispose > 0)
            {
                ...
                if (lastImage != null)
                {
                    ...
                    int[] prev = GetPixels(new Image(lastImage));
