...
public class ObjectMerge : EditorWindow {
	...
	private static int DifferenceCursor;

	public static void PrevDifference() {
	}

	public static void NextDifference() {
	}

	public static void UpdateDifferenceCounter(ObjectHelper obj) {
		if (root == null)
			return;
		ObjectHelper cursor = root;
		while (cursor != null) {
			foreach (ObjectHelper child in cursor.children) {
