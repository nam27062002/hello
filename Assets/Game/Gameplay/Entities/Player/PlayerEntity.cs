...
public class PlayerEntity : IEntity {
	...
	public float healthFraction{ get{ return m_health / m_maxHealth; } }
	...
	void Awake () {
		...
		InstanceManager.playerEntity = this;
	...
	public bool IsStarving() {
		return (m_health < m_maxHealth * m_healthWarningThreshold);
	}
	...
	{
		return (m_health < m_maxHealth * m_healthCriticalThreshold);
	}
	...
	public void SetHealthModifier( float value )
	{
		...
		m_maxHealth = m_healthBase + (m_healthModifier / 100.0f * m_healthBase);
		m_health = m_maxHealth;
	}
