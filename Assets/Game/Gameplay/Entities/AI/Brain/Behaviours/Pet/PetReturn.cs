...
namespace AI {
	namespace Behaviour {	
		[CreateAssetMenu(menuName = "Behaviour/Pet Return")]
		public class PetReturn : StateComponent {

			[StateTransitionTrigger]
			private static string OnEnemyInRange = "onEnemyInRange";

			[StateTransitionTrigger]
			private static string CloseEnough = "onHome";
			...
			protected override void OnUpdate() {
				if (m_timer > 0f) {
					...
					// Transition( OnEnemyInRange, param);
				}
			}
		}
	}
