	...
	override protected void DoLaunch() {
		...
		if (FeatureSettingsManager.instance.IsMiniTrackingEnabled) {
			...
			MiniTrackingEngine.TrackEvent(
				...
				new TrackingParam("time_played", ResultsScreenController_NEW.time),
				new TrackingParam("sc_collected", ResultsScreenController_NEW.coins),
				new TrackingParam("sc_survival_bonus", ResultsScreenController_NEW.survivalBonus),
				...
				new TrackingParam("score_total", ResultsScreenController_NEW.score),
