...
public class HUDMessage : MonoBehaviour {
	...
	virtual protected void OnEnable() {
		...
		switch(m_hideMode) {
			case HideMode.TIMER:			Messenger.AddListener(GameEvents.GAME_STARTED, OnGameStarted);	break;
		}
	}
	...
	virtual protected void OnDisable() {
		...
		switch(m_hideMode) {
			case HideMode.TIMER:			Messenger.RemoveListener(GameEvents.GAME_STARTED, OnGameStarted);	break;
		}
	}
