...
public partial class GlobalEvent {
	...
	public class Reward {
		...
		public void Collect() {
			switch (type) {
				case Type.SC:	UsersManager.currentUser.AddCurrency(UserProfile.Currency.SOFT, (long)amount);		break;
				case Type.PC:	UsersManager.currentUser.AddCurrency(UserProfile.Currency.HARD, (long)amount);			break;
