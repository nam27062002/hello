...
public class Mission {
	...
	public TimeSpan cooldownElapsed { get { return GameServerManager.GetEstimatedServerTime() - m_cooldownStartTimestamp; }}
	...
	public void ChangeState(State _newState) {
		...
		switch(_newState) {
			case State.COOLDOWN: {
				// Store timestamp
				m_cooldownStartTimestamp = GameServerManager.GetEstimatedServerTime();
			} break;
	...
	public void SkipCooldownTimer(float _seconds, bool _useAd, bool _useHC) {
		...
		if((GameServerManager.GetEstimatedServerTime() - m_cooldownStartTimestamp).TotalSeconds >= MissionManager.GetCooldownPerDifficulty(m_difficulty)) {
			if (_useAd || _useHC) {
