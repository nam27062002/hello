...
/// </summary>
[CustomPropertyDrawer(typeof(EntitySeasonalPrefabListAttribute))]
public class EntitySeasonalPrefabListAttributeEditor : ExtendedPropertyDrawer {
	//------------------------------------------------------------------//
	// MEMBERS															//
	//------------------------------------------------------------------//
