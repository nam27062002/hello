...
//----------------------------------------------------------------------//
/// <summary>
/// Drawer for the PetSkuList custom attribute.
...
/// </summary>
[CustomPropertyDrawer(typeof(PetSkuListAttribute))]
public class PetSkuListAttributeEditor : ExtendedPropertyDrawer {
	//------------------------------------------------------------------//
	// MEMBERS															//
	//------------------------------------------------------------------//
