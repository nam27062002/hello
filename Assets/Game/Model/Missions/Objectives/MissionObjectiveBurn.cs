...
//----------------------------------------------------------------------//
/// <summary>
/// Burn mission objective.
/// </summary>
[Serializable]
public class MissionObjectiveBurn : MissionObjective {
	//------------------------------------------------------------------//
	// MEMBERS															//
	//------------------------------------------------------------------//
	...
	public MissionObjectiveBurn(Mission _parentMission) : base(_parentMission) {
		// Store targets
