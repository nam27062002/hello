...
public class TutorialMapButton : MonoBehaviour {
	...
	private void OnDestroy() {
		Messenger.RemoveListener<IEntity,Reward>(MessengerEvents.ENTITY_EATEN, StartAnim);
	...
	private void Update() {
		...
		case State.Delay:
			...
			if (m_timer.IsFinished()) {
				m_state = State.Idle;
				Messenger.AddListener<IEntity,Reward>(MessengerEvents.ENTITY_EATEN, StartAnim);
			}
			break;
